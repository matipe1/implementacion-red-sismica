...
@NoArgsConstructor
@AllArgsConstructor
@ToString // @ToString(exclude = {"seriesTemporales", "analistaSupervisor", "cambiosDeEstado", "estadoActual", "clasificacionSismo", "origenDeGeneracion", "alcanceSismo"}) - Si hay relaciones bidireccionales
