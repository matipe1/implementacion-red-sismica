...
//     private static final List<Estado> ALL_ESTADOS = DatosSimulados.obtenerEstados();
...
//     private static final List<Sismografo> ALL_SISMOGRAFOS = DatosSimulados.obtenerSismografos();

//     public static void opcionRegistrarRevisionManual() {
//         List<EventoSismico> eventosSismicosAutoDetectados = buscarEventosAutoDetectados(ALL_EVENTOS);
//         List<EventoSismico> eventosOrdenados = ordenarEventosSismicos(eventosSismicosAutoDetectados);

//         InterfazRegistroRevision.mostrarEventosEncontrados(eventosOrdenados);
//     }

//     private static List<EventoSismico> buscarEventosAutoDetectados(List<EventoSismico> eventosSismicos) {
...
//     private static List<EventoSismico> ordenarEventosSismicos(List<EventoSismico> eventosAutodetectados) {
...
//         String[] datosSismicosDeEventoSeleccionado = buscarDatosSismicosDeEvento(eventoSeleccionado);
...
//         Map<Integer, List<SerieTemporal>> seriesTemporalesClasificadas = buscarSeriesTemporalesClasificadas(eventoSeleccionado);

//         if (llamarCUGenerarSismograma(seriesTemporalesClasificadas)){
//             System.out.println("Se llamó al CU Generar Sismograma pasándole la lista de muestras.");
//             }
//     }

//     // ESTE METODO SERIA EL DISPARADOR PARA OBTENER UN MAP CON LAS SERIES TEMPORALES CLASIFICADAS
//     public static Map<Integer, List<SerieTemporal>> buscarSeriesTemporalesClasificadas(EventoSismico eventoSeleccionado) {
//         return eventoSeleccionado.obtenerSeriesTemporalesClasificadas(ALL_SISMOGRAFOS);
//     }
...
//         eventoSeleccionado.bloquear(estadoBloqueadoEnRevision, fechaHoraActual, null);
//     }
...
//     private static String[] buscarDatosSismicosDeEvento(EventoSismico eventoSeleccionado) {
//         return new String[] {
...
//     con las series temporales clasificadas por codigo de estacion para que pueda operar*/
//     private static Boolean llamarCUGenerarSismograma(Map<Integer, List<SerieTemporal>> seriesTemporalesClasificadas){
...
//         return (eventoSeleccionado.getValorMagnitud() != null && eventoSeleccionado.getAlcanceSismo() != null && eventoSeleccionado.getOrigenDeGeneracion() != null);
//     }
...
//         eventoSeleccionado.rechazar(estadoRechazado, fechaHoraActual, empleadoLogueado);
//     }
...
//         System.out.println("Se ha ejecutado el CU Registrar resultado de revisión manual con éxito.");
//     }
// }